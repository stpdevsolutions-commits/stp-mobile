...
const s = StyleSheet.create({
  ...
  typeTitle: { fontSize: 18, fontWeight: '700', color: '#fff' },
  ...
  stepTitle: { textAlign: 'center', fontSize: 15, fontWeight: '700', color: '#333', paddingVertical: 8, backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#EEE' },
  content: { flex: 1 },
  input: { borderWidth: 1, borderColor: '#DDD', borderRadius: 8, padding: 10, fontSize: 15, backgroundColor: '#fff', color: '#222' },
  textarea: { height: 100, textAlignVertical: 'top' },
  nav: { flexDirection: 'row', padding: 10, backgroundColor: '#fff', borderTopWidth: 1, borderTopColor: '#EEE', gap: 8 },
  ...
  saveBtn: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: '#E3F2FD', alignItems: 'center' },
  saveBtnText: { color: '#1565C0', fontWeight: '600' },
  nextBtn: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: '#1565C0', alignItems: 'center' },
