...
const s = StyleSheet.create({
  ...
  code: { fontSize: 12, fontWeight: '700', color: '#BBDEFB', letterSpacing: 0.8 },
  statusBadge: { alignSelf: 'flex-start', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 4, marginVertical: 8 },
  statusText: { color: '#fff', fontWeight: '700', fontSize: 12 },
  headerSub: { fontSize: 13, color: '#BBDEFB', marginTop: 3 },
  gps: { fontSize: 11, color: '#81D4FA', marginTop: 4 },
  pdfBtn: { margin: 12, marginBottom: 0, backgroundColor: '#fff', borderRadius: 12, padding: 14, alignItems: 'center', borderWidth: 1.5, borderColor: '#1565C0', flexDirection: 'row', justifyContent: 'center', gap: 8 },
  pdfBtnText: { color: '#1565C0', fontWeight: '700', fontSize: 15 },
  section: { backgroundColor: '#fff', margin: 12, marginTop: 12, borderRadius: 14, padding: 16, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8, shadowOffset: { width: 0, height: 2 }, elevation: 2 },
  sectionTitle: { fontSize: 12, fontWeight: '700', color: '#94A3B8', marginBottom: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: '#F1F5F9', textTransform: 'uppercase', letterSpacing: 1 },
  subLabel: { fontSize: 13, fontWeight: '700', color: '#1565C0', marginTop: 12, marginBottom: 6 },
  subCard: { backgroundColor: '#F8FAFC', borderRadius: 10, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: '#E2E8F0' },
  ...
  rowValue: { fontSize: 13, color: '#0D1B2A', fontWeight: '600', flex: 1, textAlign: 'right' },
  ...
  actions: { margin: 12 },
  submitBtn: { backgroundColor: '#1565C0', borderRadius: 12, padding: 16, alignItems: 'center', shadowColor: '#1565C0', shadowOpacity: 0.4, shadowRadius: 8, elevation: 5 },
